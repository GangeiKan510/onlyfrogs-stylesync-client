  ...
  return (
    <Pressable className={buttonStyles} onPress={callBack}>
      <View className="flex-1 justify-center items-center">
        {isLoading 
          ? <ActivityIndicator size={"small"} color={type === "primary" ? "#fff" : "#7ab2b2"} /> 
