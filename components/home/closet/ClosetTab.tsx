        ...
        <View className="w-4/5 bg-white rounded-[10px] p-5 items-center">
          ...
          <View className="w-full">
            <View className='mb-3 mt-4'>
              <Text className='text-[16px] mb-1 self-start'>Name {isClosetNameEmpty && <Text className="text-[#EE4E4E]">*Closet name is required</Text>}</Text>
              <TextInput
            ...
            <View>
              <Text className="mx-10 my-4 text-text-secondary">Make your closet name reflect the type of clothes you want to store.</Text>
            </View>
          </View>
          <View className="flex-row justify-between w-full">
            ...
            >
              <Text className="text-base text-center text-text-tertiary">Cancel</Text>
            </Pressable>
            <Pressable 
            ...
            >
              <Text className="text-base text-white text-center">{isRequestLoading ? <ActivityIndicator size={"small"} color={"#fff"} /> : "Add"}</Text>
            </Pressable>
          </View>
        </View>
      </View>
