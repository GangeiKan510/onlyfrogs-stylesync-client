import { TextInput, View, Text, Pressable, KeyboardAvoidingView, Alert } from 'react-native';
...
export default function Register() {
  ...
  const handleSignUp = async () => {
    ...
    const { success, message } = validateForm(firstName, lastName, email, password, confirmPassword);
    ...
    try {
      ...
      console.error(error);
      Alert.alert('Registration Error', 'Please check your credentials and try again.');
      setLoading(false);
    }
  };
        ...
        <View className='mx-8 mt-16'>
          ...
          <View>
            ...
            <View>
              ...
              <Link href={routes.login} className='text-[#7ab2b2] underline text-center mt-3'>
